...
const analyzeSchema = z.object({ action: z.literal('analyze'), resume_text: z.string().min(1) })
const matchSchema = z.object({ action: z.literal('match'), resume_text: z.string().min(1), jd_text: z.string().min(1) })
const coverLetterSchema = z.object({ action: z.literal('cover_letter'), job_title: z.string().min(1), company: z.string().min(1), resume_text: z.string().min(1) })
